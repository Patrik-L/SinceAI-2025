...
package xyz.patu.spacialRecorder.spacialRecorder;
...
import xyz.patu.spacialRecorder.common.helpers.TapHelper;
import xyz.patu.spacialRecorder.common.helpers.TrackingStateHelper;
import xyz.patu.spacialRecorder.common.rendering.BackgroundRenderer;
import xyz.patu.spacialRecorder.common.rendering.ObjectRenderer;
 ...
 * </ul>
 */
public class SpacialRecorderActivity extends AppCompatActivity
        implements GLSurfaceView.Renderer, ImageReader.OnImageAvailableListener {
    private static final String TAG = SpacialRecorderActivity.class.getSimpleName();
    ...
    CameraCaptureSession.StateCallback cameraSessionStateCallback =
            new CameraCaptureSession.StateCallback() {
                ...
                public void onActive(@NonNull CameraCaptureSession session) {
                    ...
                    synchronized (SpacialRecorderActivity.this) {
                        captureSessionChangesPossible = true;
                        SpacialRecorderActivity.this.notify();
                    }
                }
    ...
    private void openCamera() {
        ...
        try {
            ...
            focalLength = Objects.requireNonNull(characteristics.get(CameraCharacteristics.LENS_INFO_AVAILABLE_FOCAL_LENGTHS))[0];
    ...
    private JSONObject imageToSpacialImage(Image image) {
        ...
        try {
            ...
            spacialImage.put("position", position);
            spacialImage.put("focalLength", focalLength);
            spacialImage.put("rotation", new JSONArray(currentPosition.getRotationQuaternion()));
            Log.i(TAG, "New spacial image: " + spacialImage);
            spacialImage.put("imageData", encodedString);
        } catch (JSONException e) {
    ...
    public void onDrawFrameARCore() throws CameraNotAvailableException {
        ...
        currentPosition = camera.getDisplayOrientedPose();

        runOnUiThread(
                () -> {
                    coordinateTextView.setText(Arrays.toString(currentPosition.getTranslation()));
                });
